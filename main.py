...
BASE_URL_WIN = "https://github.com/acierto-incomodo/fastfood/releases/latest/download/Build.zip"
...
URL_7ZR = "https://github.com/acierto-incomodo/fastfood/releases/latest/download/7zr.exe"
...
class LauncherWindow(QtWidgets.QWidget):
    ...
    def __init__(self):
        super().__init__()
        self.setWindowTitle("Fast Food Simulator - Launcher")
    ...
    def setup_ui(self):
        ...
        title = QtWidgets.QLabel("Fast Food Simulator")
